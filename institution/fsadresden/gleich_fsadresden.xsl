...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:err="http://www.w3.org/2005/xqt-errors"
                ...
                xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs xdt err fn" version="2.0">
        ...
        <xsl:for-each select="//Record">
            ...
            <xsl:element name="record">
                ...
                <xsl:element name="vufind">
                    ...
                    <!--recordType-->
                    <xsl:choose>
                        <xsl:when test="contains(AdministrativeData/EditForm, 'Druckschrften')">
                            <recordType>
                ...
                <xsl:element name="institution">
                    ...
                    <!--linkToWebpage-->
                    <link>
                        <xsl:text>http://www.ida-dachverband.de/einrichtungen/deutschland/frauenstadtarchiv-dresden/</xsl:text>
                    </link>
                ...
                <xsl:element name="dataset">
                        ...
                        <xsl:when test="contains(AdministrativeData/EditForm, 'Bücher / Druckschrften')">
                            ...
                            <searchfilter>
                                <xsl:variable name="title">
                                    <xsl:value-of
                                            select="DetailData/DataElement[@ElementName='Titel']/ElementValue/TextValue"/>
                                    <xsl:value-of
                                            select="DetailData/DataElement[@ElementName='Untertitel']/ElementValue/TextValue"/>
                                    <xsl:value-of
                                            select="DetailData/DataElement[@ElementName='Titelzusätze']/ElementValue/TextValue"/>
                                </xsl:variable>
                                <xsl:choose>
                    ...
                    <title>
                        <xsl:value-of
                                select="DetailData/DataElement[@ElementName='Titel']/ElementValue/TextValue"></xsl:value-of>
                    </title>
                    <title_short>
                        <xsl:value-of
                                select="DetailData/DataElement[@ElementName='Titel']/ElementValue/TextValue"></xsl:value-of>
                    ...
                    <xsl:if test="not(DetailData/DataElement[@ElementName='Enthält']) and DetailData/DataElement[@ElementName='Autoren u. sonst. beteiligte Personen']">
                        <description>
                            <xsl:value-of
                                    select="DetailData/DataElement[@ElementName='Autoren u. sonst. beteiligte Personen']/ElementValue/TextValue"/>
                        </description>
                    </xsl:if>
                    ...
                    <xsl:if test="DetailData/DataElement[@ElementName='Reihentitel']">
                        <series>
                            <xsl:value-of
                                    select="DetailData/DataElement[@ElementName='Reihentitel']/ElementValue/TextValue"/>
                        </series>
                    </xsl:if>
                    ...
                    <xsl:if test="DetailData/DataElement[@ElementName='ISBN']">
                        <isbn>
                            <xsl:value-of
                                    select="DetailData/DataElement[@ElementName='ISBN']/ElementValue/TextValue"></xsl:value-of>
                        </isbn>
                    </xsl:if>
                    ...
                    <xsl:if test="DetailData/DataElement[@ElementName='Entstehungszeitraum']/ElementValue/DateRange/FromDate!=''">
                        <displayPublishDate>
                            <xsl:value-of
                                    select="substring(translate(DetailData/DataElement[@ElementName='Entstehungszeitraum']/ElementValue/DateRange/FromDate, translate(.,'0123456789', ''), ''),1,4)"></xsl:value-of>
                            <xsl:if test="translate(DetailData/DataElement[@ElementName='Entstehungszeitraum']/ElementValue/DateRange/ToDate, translate(.,'0123456789', ''), '')">
                                <xsl:text> - </xsl:text>
                                <xsl:value-of
                                        select="translate(DetailData/DataElement[@ElementName='Entstehungszeitraum']/ElementValue/DateRange/ToDate, translate(.,'0123456789', ''), '')"></xsl:value-of>
                            </xsl:if>
                        </displayPublishDate>
                        <publishDate>
                            <xsl:value-of
                                    select="substring(translate(DetailData/DataElement[@ElementName='Entstehungszeitraum']/ElementValue/DateRange/FromDate, translate(.,'0123456789', ''), ''),1,4)"/>
                        </publishDate>
                        <publishDate>
                            <xsl:value-of
                                    select="substring(translate(DetailData/DataElement[@ElementName='Entstehungszeitraum']/ElementValue/DateRange/ToDate, translate(.,'0123456789', ''), ''),1,4)"/>
                        </publishDate>
                    </xsl:if>
                    ...
                    <xsl:if test="DetailData/DataElement[@ElementName='Verlagsort / Verlag']">
                        <xsl:choose>
                            <xsl:when
                                    test="contains(DetailData/DataElement[@ElementName='Verlagsort / Verlag']/ElementValue/TextValue,',')">
                                <publisher>
                                    <xsl:variable name="publisher">
                                        <xsl:value-of
                                                select="normalize-space(substring-before(DetailData/DataElement[@ElementName='Verlagsort / Verlag']/ElementValue/TextValue,','))"></xsl:value-of>
                                    </xsl:variable>
                                    <xsl:choose>
                                        <xsl:when test="contains($publisher,'Druck:')">
                                            <xsl:value-of
                                                    select="normalize-space(substring-after($publisher,'Druck:'))"></xsl:value-of>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            <xsl:value-of
                                                    select="normalize-space(substring-before(DetailData/DataElement[@ElementName='Verlagsort / Verlag']/ElementValue/TextValue,','))"></xsl:value-of>
                                ...
                                <placeOfPublication>
                                    <xsl:value-of
                                            select="normalize-space(substring-after(DetailData/DataElement[@ElementName='Verlagsort / Verlag']/ElementValue/TextValue,','))"></xsl:value-of>
                                </placeOfPublication>
                            </xsl:when>
                            <xsl:otherwise>
                                <publisher>
                                    <xsl:choose>
                                        <xsl:when
                                                test="contains(DetailData/DataElement[@ElementName='Verlagsort / Verlag'],'Druck:')">
                                            <xsl:value-of
                                                    select="normalize-space(substring-after(DetailData/DataElement[@ElementName='Verlagsort / Verlag'],'Druck:'))"></xsl:value-of>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            <xsl:value-of
                                                    select="normalize-space(DetailData/DataElement[@ElementName='Verlagsort / Verlag']/ElementValue/TextValue)"></xsl:value-of>
                                        </xsl:otherwise>
                                    </xsl:choose>
                                </publisher>
                            </xsl:otherwise>
                    ...
                    <xsl:if test="not(@Level='Bestand')">
                        <sourceInfo>
                            <xsl:value-of
                                    select="normalize-space(//Record[@Level='Bestand']/DetailData/DataElement[@ElementName='Titel']/ElementValue/TextValue)"/>
                        </sourceInfo>
                    </xsl:if>
                    ...
                    <xsl:if test="DetailData/DataElement[@ElementName='Seitenzahl']">
                        <physical>
                            <xsl:choose>
                                <xsl:when test="contains(AdministrativeData/EditForm, 'Bücher / Druckschrften')">
                                    <xsl:value-of
                                            select="translate(DetailData/DataElement[@ElementName='Seitenzahl']/ElementValue/TextValue, translate(.,'0123456789', ''), '')"/>
                                </xsl:when>
                                <xsl:otherwise>
                                    <xsl:value-of
                                            select="DetailData/DataElement[@ElementName='Seitenzahl']/ElementValue/TextValue"></xsl:value-of>
                                </xsl:otherwise>
                            </xsl:choose>
                    ...
                    <xsl:if test="DetailData/DataElement[@ElementName='Enthält']">
                        <description>
                            ...
                            <xsl:value-of
                                    select="DetailData/DataElement[@ElementName='Enthält']/ElementValue/TextValue"/>
                        </description>
                    </xsl:if>
                    ...
                    <shelfMark>
                        <xsl:value-of
                                select="DetailData/DataElement[@ElementName='Signatur']/ElementValue/TextValue"/>
                    </shelfMark>
                </xsl:element>
                ...
                <xsl:if test="@Level='Klassifikationsgruppe'">
                    ...
                    <functions>
                        <hierarchyFields>
                            ...
                            <hierarchy_top_id>
                                <xsl:value-of select="//Record[@Level='Bestand']/@Id"/><xsl:text>fsadresden</xsl:text>
                            </hierarchy_top_id>
                            <hierarchy_top_title>
                                <xsl:value-of
                                        select="//Record[@Level='Bestand']/DetailData/DataElement[@ElementName='Titel']/ElementValue/TextValue"/>
                            </hierarchy_top_title>

                            <hierarchy_parent_id>
                                <xsl:value-of select="@ParentId"/><xsl:text>fsadresden</xsl:text>
                            </hierarchy_parent_id>
                            <hierarchy_parent_title>
                                <xsl:value-of
                                        select="//Record[@Id=$related]/DetailData/DataElement[@ElementName='Titel']/ElementValue/TextValue"/>
                            </hierarchy_parent_title>
